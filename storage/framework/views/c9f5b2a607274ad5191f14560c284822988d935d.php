...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea class="form-control" id="post_edit" rows="3" name="content"><?php echo e($post->content); ?></textarea>
        <script>
            tinymce.init({
...
<div>
    <div class="text-right">
        <a  data-toggle="collapse" href="#lang_content" role="button" aria-expanded="false" aria-controls="lang_content">
            Thêm ngôn ngữ
        </a>
    </div>
    <div class="collapse multi-collapse" id="lang_content">
        <div class="form-group">
            <label class="font-weight-bold"> Nội dung tiếng anh</label>
            <textarea class="form-control" id="content_en" rows="3" name="content_en"><?php echo e($post->content_en); ?></textarea>
            <?php echo e(F_tinymce('content_en')); ?>
...
</div><?php /**PATH /home/webux/domains/auth.webux.vn/public_html/app/Modules/Post/Views/inc_edit/content.blade.php ENDPATH**/ ?>