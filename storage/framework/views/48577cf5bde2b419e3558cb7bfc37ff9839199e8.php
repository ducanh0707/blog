        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
               ...
               <a class="btn btn-sm btn-warning" href="<?php echo e(asset('admin/order/mailConfig')); ?>">Cài đặt mail</a>
            </div>
            <?php echo $__env->make('Order::new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="">
                                    ...
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body text-left">
                                            ...
                                            <div class="row">
                                                   ...
                                                   <div class="col-md-12">
                                                         Trạng thái gửi mail: <?php if($val->sendmail == 'on'): ?> Đã gửi <?php else: ?> Chưa gửi <?php endif; ?>
                                                   </div>   
...
<?php echo $__env->make('V_backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\cid18\app\Modules/Order/Views/index.blade.php ENDPATH**/ ?>