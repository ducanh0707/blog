                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="name_cat_seo">Mô tả ngắn</label>
                                    <textarea class="form-control" name="des_en"><?php echo e(old('des_en')); ?></textarea>
                                </div>
                        </div>
                        <div class="col-md-6">
                            <!-- tiêu đề SEO -->
                            <div class="form-group">
                                <label for="name_cat_seo">Tiêu đề SEO</label>
                                <input type="text" class="form-control"  placeholder="Bạn điền tiêu đề SEO" name="title_seo_en" value="<?php echo e(old('title_seo_en')); ?>">
                            </div>
                            <!-- mô tả danh mục  -->
                            <div class="form-group">
                                <label>Mô tả danh mục (SEO - Meta Description)</label>
                                <textarea  class="form-control"  rows="3" name="des_seo_en" placeholder="Bạn điền mô tả danh mục (tối đa 325 ký tự)" ><?php echo e(old('des_seo_en')); ?></textarea>
                            </div>
                            <!-- meta keyword-->
                            <div class="form-group">
                                <label for="name_cat">Keyword(SEO - Meta keyword)</label>
                                <input type="text" class="form-control"  placeholder="Bạn điền keyword, cách nhau dấu phẩy" name="key_seo_en" value="<?php echo e(old('key_seo_en')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo e(F_input_image('','img','new_cat','source/cat')); ?>
...
<?php /**PATH /home/webux/domains/auth.webux.vn/public_html/app/Modules/Cat/Views/IV_modal_cat_new.blade.php ENDPATH**/ ?>