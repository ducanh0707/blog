<div class="modal fade" id="popup_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <script>
    ...
    event.stopPropagation();
        ...
        $.ajax({
        type:'POST',
            url: '<?php echo e(asset("admin/post/bai-viet/image_upload")); ?>',
            data: formData,
            cache:false,
            contentType: false,
            processData: false,
...
<?php /**PATH /home/webux/domains/auth.webux.vn/public_html/app/Modules/Post/Views/modal_upload_image.blade.php ENDPATH**/ ?>