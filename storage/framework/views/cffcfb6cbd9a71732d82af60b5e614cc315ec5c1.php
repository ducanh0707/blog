...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <select class="form-control" name="width">
        ...
        <option value="container" <?php if($row->width == 'container'): ?> selected <?php endif; ?>>Có lề</option>
        <option value="container-fluid" <?php if($row->width == 'container-fluid'): ?> selected <?php endif; ?>>Không lề</option>
    </select>
</div>
<div class="form-group">
    <label> Vị trí</label>
...
<?php /**PATH /home/webux/domains/auth.webux.vn/public_html/app/Modules/Theme/Views/inc/inc_row_input_right.blade.php ENDPATH**/ ?>