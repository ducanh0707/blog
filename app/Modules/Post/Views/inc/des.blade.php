<div class="col-md-12">
    ...
    <script>
        ...
        selector: '#post_new_des',height: 400,
        relative_urls:false,
        ...
        contextmenu: "image | inserttable | bold italic | fontsizes | align | removeformat | link unlink",
        rel_list: [
...
<div>
    ...
    <div class="collapse multi-collapse" id="lang_des">
        <div class="form-group">
            ...
            <textarea class="form-control" id="des_en" rows="3" name="des_en">{{old('des_en')}}</textarea>
            {{ F_tinymce('des_en')}}
        </div>
