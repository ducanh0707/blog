            ...
            <input id="seo_title" type="text" class="form-control" placeholder="Bạn điền tiêu đề" name="title_seo"
                ...
                <div>
                    <div class="text-right">
                        <a  data-toggle="collapse" href="#title_seo" role="button" aria-expanded="false" aria-controls="title_seo">
                            Thêm ngôn ngữ
                        </a>
                    </div>
                    <div class="collapse multi-collapse" id="title_seo">
                        <div class="form-group">
                            ...
                            <input  type="text" class="form-control"  name="title_seo_en" value="{{old('title_seo_en')}}">
                        </div>
                ...
                <div>
                    ...
                    <div class="collapse multi-collapse" id="des_seo">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" rows="3" name="des_seo_en">{{old('des_seo_en')}}</textarea>
                        </div>
                ...
                <div>
                    ...
                    <div class="collapse multi-collapse" id="key_seo">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" rows="3" name="key_seo_en"  value="{{ old('key_seo_en') }}">
                        </div>
