                                    ...
                                    <div>
                                        ...
                                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="title_en"  value="{{$post->title_en}}" maxlength="500">
                                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" type="radio" name="status" id="on" value="on" @if($post ->
                                        status =='on') {{'checked'}} @endif class="custom-control-input">
                                        <label class="custom-control-label" for="on">Công khai</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" type="radio" name="status" id="off" value="off" @if($post ->
                                        status !='on') {{'checked'}} @endif class="custom-control-input">
